 ...
 */
public class ExpiredReservationException extends RuntimeException implements ErrorResponse {
	...
	public ProblemDetail getBody() {
		ProblemDetail detail = ProblemDetail.forStatusAndDetail(this.httpStatus,
			String.format("예약 ID %d는 이미 만료됨", this.reservationId));
		detail.setTitle("만료된 예약");
